...
import main.java.core.IntHashSet;
...
public class IntHashSetTest {
  ...
  public void entryIsNotDeclaredInThePackage() {
    assertThrows(ClassNotFoundException.class, () -> Class.forName("main.java.core.Entry"));
  }
  ...
  public void entryIsDeclaredInsideIntHashSet() {
    assertTrue(Arrays.stream(IntHashSet.class.getDeclaredClasses())
        .anyMatch(type -> type.getName().equals("main.java.core.IntHashSet$Entry")));
  }

  @Test
  @Tag("Q1")
  public void entryIsARecord() throws ClassNotFoundException {
    var type = Class.forName("main.java.core.IntHashSet$Entry");
